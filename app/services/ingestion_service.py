...
class IngestionService:
    def __init__(self, transcript_service: transcript_service.TranscriptService, chunk_service: chunk.ChunkService, embedding_service: embedding_service.EmbeddingService,vector_db_service:vector_db.VectorDBService):
...
def get_ingestion_service(
        ...
        chunk_service: chunk.ChunkService = Depends(chunk.get_chunk_service),
